    ...
    return (
      <Layout>
        <div className='flex min-h-[70vh] flex-col items-center justify-center gap-6 px-6 text-center'>
          <svg className='h-8 w-8 animate-spin text-[#ffb3ae]' viewBox='0 0 24 24'>
            <circle className='opacity-25' cx='12' cy='12' r='10' stroke='currentColor' strokeWidth='4' fill='none' />
            <path className='opacity-75' fill='currentColor' d='M4 12a8 8 0 018-8V0C5.373 0 0 5.373 0 12h4z' />
          </svg>
          <p className='text-lg text-[#d1c3c1]/70'>Confirmando tu pago...</p>
        </div>
      </Layout>
    )
  }
    ...
    return (
      <Layout>
        <div className='flex min-h-[70vh] flex-col items-center justify-center gap-6 px-6 text-center'>
          ...
          <h1 className='text-5xl font-black uppercase text-white'>Error en el Pago</h1>
          <p className='text-[#d1c3c1]/70'>Hubo un problema al verificar tu pago.</p>
          <button
  ...
  return (
    <Layout>
      <div className='flex min-h-[70vh] flex-col items-center justify-center gap-6 px-6 text-center'>
        ...
        <p className='text-[#d1c3c1]/70'>El pago fue rechazado. Pod&eacute;s intentar nuevamente.</p>
        <div className='w-full max-w-xs'>
          <PaymentButton pedidoId={pedidoId} monto={orderTotal ?? 0} />
        </div>
        <Link
          to='/cart'
          className='text-sm uppercase tracking-[0.2em] text-[#ab8986] transition hover:text-white'
        >
          Volver al carrito
        </Link>
      </div>

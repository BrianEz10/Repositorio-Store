      ...
      <main className='mx-auto max-w-7xl px-6 py-14'>
        ...
        <div className='grid grid-cols-1 gap-10 lg:grid-cols-12'>
          ...
          <aside className='lg:col-span-4'>
            {!token ? (
              <div className='sticky top-28 space-y-6 border border-[#5b403e]/20 bg-[#1a1a1a] p-8 text-center'>
                <h3 className='text-xl font-black uppercase text-white'>Iniciá sesión</h3>

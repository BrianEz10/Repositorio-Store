    ...
    <>
      <div className='space-y-4 border border-[#5b403e]/20 bg-[#1c1b1b] p-4'>
        ...
        <button type='button' onClick={handleSave} disabled={isSaving}
          className='w-full border border-[#ffb3ae] py-3 text-sm font-bold uppercase tracking-[0.2em] text-[#ffb3ae] transition hover:bg-[#ffb3ae] hover:text-black cursor-pointer'>

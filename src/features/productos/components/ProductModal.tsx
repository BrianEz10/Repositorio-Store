    ...
    <div className='fixed inset-0 z-50 flex items-center justify-center bg-black/70 px-6'>
      <div className='w-full max-w-2xl border border-[#5b403e]/20 bg-[#1a1a1a] p-8'>
        <div className='mb-8 flex items-center justify-between'>
          ...
          <button
            onClick={onClose}
            className='text-2xl text-[#ffb3ae]'
          >
            ✕
          </button>
        </div>
        ...
        <form className='space-y-6'>
          ...
          <button className='w-full border border-[#ffb3ae] bg-[#ffb3ae] py-4 text-sm font-bold uppercase tracking-[0.2em] text-black transition hover:opacity-90'>
            Guardar Producto
          </button>
        </form>
      </div>

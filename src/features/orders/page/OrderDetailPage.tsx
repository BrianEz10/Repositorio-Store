    ...
    return (
      <Layout>
        <main className='mx-auto max-w-4xl px-6 py-14'>
          <div className='mb-10'>
            <div className='mb-6 h-8 w-36 rounded bg-[#2a2a2a] animate-pulse' />
            <div className='h-12 w-64 rounded bg-[#2a2a2a] animate-pulse' />
          </div>
          <OrderDetailSkeleton />
        </main>
      </Layout>
    ...
    return (
      <Layout>
        <div className='flex min-h-[70vh] flex-col items-center justify-center gap-6 px-6 text-center'>
          ...
          <p className='text-[#d1c3c1]/70'>El pedido que buscas no existe o no tienes acceso.</p>
          <Link to='/orders' className='border border-[#ffb3ae] bg-[#ffb3ae] px-6 py-4 text-sm font-bold uppercase tracking-[0.2em] text-black transition hover:opacity-90'>
      ...
      <main className='mx-auto max-w-4xl px-6 py-14'>
        <div className='mb-10'>
          <button
            ...
            className='mb-6 border border-[#5b403e]/40 px-4 py-2 text-xs font-bold uppercase tracking-[0.2em] text-[#e4beba] transition hover:border-[#ffb3ae] hover:text-[#ffb3ae] cursor-pointer'
          >
            ← Volver a pedidos
          </button>
            ...
            <div className='border border-[#5b403e]/20 bg-[#1a1a1a] p-8'>
              {showConfirm ? (
                <div className='flex items-center gap-4'>
                  <span className='text-sm text-[#d1c3c1]/70'>¿Cancelar pedido?</span>
                  <button
                  ...
                  <button
                    ...
                    className='border border-[#5b403e]/40 px-4 py-2 text-xs font-bold uppercase tracking-[0.2em] text-[#e4beba] transition hover:border-[#ffb3ae] cursor-pointer'
                  >
                    No
                  </button>
                </div>
